...
from .modules import authorize, list, cancel_mirror, mirror_status, mirror, clone, shell, eval, torrent_search, delete, speedtest, count, reboot
...
def start(update, context):
    ...
    buttons.buildbutton("Channel", "https://github.com/SlamDevs/slam-mirrorbot")
    buttons.buildbutton("Donate", "https://saweria.co/wibumylife")
